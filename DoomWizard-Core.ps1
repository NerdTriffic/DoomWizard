...
Clear-Host
# ==========================================
# PortMaster DoomWizard v0.1.3 by Nerd Triffic
# ==========================================
...
$Selection = Read-Host "Select Mods (Example: 1,2,3 or press ENTER for none)"
...
if ($Selected.Count -eq 0) {
    ...
    Write-Host "Creating vanilla IWAD launcher."
...
Write-Host "PortMaster Doom Wizard v0.1.3"
Write-Host ""
